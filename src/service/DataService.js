export const DataService = {
    ...
    getShowData1() {
        ...
        try {
            fetch("Placings/2023BelgianMeritPlacings.json")
                .then(async response => {
                    ...
                    placingDataList = Promise.resolve(data);
                    //const respData = data;
                    //return placingDataList; //Promise.resolve(placingDataList);

                    //this.placingDataList = respData.filter(classEntry => this.defaultShowSelected.some(el => el.show == classEntry.show))
                    //return Promise.resolve(respData.filter(classEntry => this.defaultShowSelected.some(el => el.show == classEntry.show)));
        ...
        return Promise.resolve(placingDataList);
    },

    getShowResults(){
        return Promise.resolve(this.getShowData());
    },
